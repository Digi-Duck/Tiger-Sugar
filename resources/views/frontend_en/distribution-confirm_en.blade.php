            ...
            <section id="distribution-confirm">
                ...
                <div class="container">
                    <div class="title-area">
                        ...
                        <div class="distribution-check">Distribution confirm</div>
                        <div class="title-bottom">
                            ...
                            <button type="button" class="delete-all btn">Delete all</button>
                ...
                <div class="container">
                    <form action="">
                        <div class="basic-fillout">
                            <div class="fill-title">Distributor Information</div>
                            <div class="basic-inside-fillout">
                                <div class="fill-input">
                                    <div class="fill-name-birthday">
                                        <div class="fill-name">
                                            <div class="fill-name-text">Name</div>
                                            <input type="text" placeholder="Name" class="fill-name-input">
                                        </div>
                                        <div class="fill-birthday">
                                            <div class="fill-birthday-text">Birthday</div>
                                            <input type="date" class="fill-birthday-input">
                                        </div>
                                    </div>

                                    <div class="fill-email">
                                        <div class="fill-email-text">Email</div>
                                        <input type="email" placeholder="Email" class="fill-email-input">
                                    </div>

                                    <div class="fill-phone">
                                        <div class="fill-phone-text">Phone</div>
                                        <input type="number" placeholder="Phone number" class="fill-phone-input">
                                    </div>

                                    <div class="fill-address">
                                        <div class="fill-address-text">Address</div>
                                        <input type="text" placeholder="Address" class="fill-address-input">
                                    </div>
                            ...
                            <div class="sales-inside-fillout">
                                <div class="sales-white-line">
                                    ...
                                    <div class="fill-other">
                                        <div class="fill-other-text">Other</div>
                                        <input type="text" placeholder="Other" class="fill-other-input">
                                    </div>

                                </div>
                                <button type="submit" class="send-info">Send</button>
                            </div>
                        </div>
                    </form>
                </div>
