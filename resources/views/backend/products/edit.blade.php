        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="/admin/products/update/{{$list->id}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input class="form-control" id="title_zh" name="title_zh" value="{{$list->title_zh}}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="title_en" class="col-2 col-form-label">商品名稱(英)</label>
                                <div class="col-10">
                                    <input class="form-control" id="title_en" name="title_en"  value="{{$list->title_en}}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="type_id" class="col-2 col-form-label">分類</label>
                                <div class="col-10">
                                    <select class="form-control" name="type_id" id="type_id" value="{{$list->type_id}}" required>
                                        @foreach($types as $type)
                                        @if ($list->type_id == $type->id)
                                            <option value="{{$type->id}}" selected>{{$type->tw_name}} | {{$type->en_name}}</option>
                                        @else
                                            <option value="{{$type->id}}">{{$type->tw_name}} | {{$type->en_name}}</option>
                                        @endif
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input type="date" class="form-control" id="launch_date" name="launch_date" value="{{$list->launch_date}}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="weight" class="col-2 col-form-label">淨重(克)</label>
                                <div class="col-10">
                                    <input type="number" class="form-control" id="weight" name="weight" value="{{$list->weight}}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="shelf_life" class="col-2 col-form-label">保存期限(月)</label>
                                <div class="col-10">
                                    <input type="number" class="form-control" id="shelf_life" name="shelf_life" value="{{$list->shelf_life}}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input type="text" class="form-control" id="video" name="video" value="{{$list->video}}">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input type="file" class="form-control" id="img" name="img" vlaue>
                                </div>
                                <div class="col-12"><p class="text-danger">*注意：建議尺寸：400 * 435 (px)</p></div>
                            </div>
                            <hr>
                            <div class="form-group row">
                                ...
                                <div class="col-10 row">                            
                                    @foreach ($list->productsImgs as $img)
                                        <div class="imgs_area mx-2 mb-2">
                                            <div class="del_btn bg-danger text-white" data-id="{{$img->id}}">X</div>
    ...
    <script>
        ...
        $('.del_btn').click(function () {
            ...
            if (yes) {
                ...
                axios.post('/admin/delProductsImage', { id: id })
                .then((res) => { 
                    alert('刪除成功');
                    $(this).parent().remove();
                })
