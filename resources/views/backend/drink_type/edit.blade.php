                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('back.drink_type.update',['id'=> $info->id])}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input class="form-control" id="type_name" name="type_name" required value="{{$info->type_name}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="type_info" class="col-2 col-form-label">副標題</label>
                                <div class="col-10">
                                    <input class="form-control" id="type_info" name="type_info" value="{{$info->type_info}}">
                                </div>
                            </div>
