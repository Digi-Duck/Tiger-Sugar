                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade @if($info->type =='圖片') show active @endif" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input type="file" class="form-control-file" id="pc_image_url" name="pc_image_url" accept="image/*" required>
                                        </div>
                                        <div class="col-12">
                                            <p class="text-danger">
                                                *注意：1.上傳後，將覆蓋掉原有照片！
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input type="file" class="form-control-file" id="mb_image_url" name="mb_image_url" accept="image/*" required>
                                        </div>
                                        <div class="col-12">
                                            <p class="text-danger">
                                                *注意：1.上傳後，將覆蓋掉原有照片！
