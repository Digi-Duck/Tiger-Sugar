        ...
        <div class="form-container">
            ...
            <form class="form main" action="{{route('front.franchisee_form.store')}}" method="POST">
                ...
                <div class="form-name">
                    ...
                    <input id="user_name" type="text" class="form-name-input" placeholder="請輸入姓名" required name="user_name">
                </div>
                <div class="form-date">
                ...
                <div class="form-email">
                    ...
                    <input id="email" type="text" class="form-email-input" placeholder="請輸入電子郵件" required name="email">
                </div>
